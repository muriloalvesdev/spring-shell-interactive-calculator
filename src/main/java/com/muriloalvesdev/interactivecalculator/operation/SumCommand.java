...
/**
 * Classe que implementa a funcionalidade de somar números em uma expressão matemática. Esta classe
 * permite a soma de números em uma expressão fornecida pelo usuário, que pode conter números e
 * operadores de soma. Exemplos aceitáveis de expressões: - "1 + 2+ 3" - "1 + 2 + 3" - "1 + 2 + 3"
 */
@ShellComponent
